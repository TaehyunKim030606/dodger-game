...
class Player():
    def __init__(self, window, window_width, game_height):
        self.window = window
        ...
        self.maxX = self.windowWidth - playerRect.width
        self.maxY = self.gameHeight - playerRect.height
    ...
    def update(self, x, y):
        ...
        player_cx = playerRect.centerx
        player_cy = playerRect.centery
        player_radius = playerRect.width // 2
